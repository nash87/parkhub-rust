...
vi.mock('@phosphor-icons/react', () => ({
  ...
  PresentationChartIcon: (props: any) => <span data-testid="icon-presentation" {...props} />,
  ...
  DatabaseIcon: (props: any) => <span data-testid="icon-database" {...props} />,
  ...
  CurrencyDollarIcon: (props: any) => <span data-testid="icon-currency" {...props} />,
  ...
  GraphicsCardIcon: (props: any) => <span data-testid="icon-graphql" {...props} />,
  ShieldCheckIcon: (props: any) => <span data-testid="icon-shield" {...props} />,
  LockKeyIcon: (props: any) => <span data-testid="icon-lock-key" {...props} />,
  MapTrifoldIcon: (props: any) => <span data-testid="icon-map-trifold" {...props} />,
  ArrowsClockwiseIcon: (props: any) => <span data-testid="icon-arrows-clockwise" {...props} />,
  ListIcon: (props: any) => <span data-testid="icon-list" {...props} />,
  XIcon: (props: any) => <span data-testid="icon-x" {...props} />,
  ArrowSquareOutIcon: (props: any) => <span data-testid="icon-arrow-square-out" {...props} />,
}));
