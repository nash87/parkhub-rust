...
vi.mock('@phosphor-icons/react', () => ({
  ...
  ShieldIcon: (props: any) => <span data-testid="icon-shield" {...props} />,
  WarningIcon: (props: any) => <span data-testid="icon-warning" {...props} />,
  ShieldCheckIcon: (props: any) => <span data-testid="icon-shield-check" {...props} />,
  BellIcon: (props: any) => <span data-testid="icon-bell" {...props} />,
  EnvelopeSimpleIcon: (props: any) => <span data-testid="icon-envelope-simple" {...props} />,
  DeviceMobileIcon: (props: any) => <span data-testid="icon-device-mobile" {...props} />,
  ...
  ShieldWarningIcon: (props: any) => <span data-testid="icon-shield-warning" {...props} />,
  CheckIcon: (props: any) => <span data-testid="icon-check" {...props} />,
  XIcon: (props: any) => <span data-testid="icon-x" {...props} />,
  PaletteIcon: (props: any) => <span data-testid="icon-palette" {...props} />,
