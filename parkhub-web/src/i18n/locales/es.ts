export default {
  translation: {
    ...
    credits: {
      title: 'Mis créditos',
      subtitle: 'Tu saldo de créditos de aparcamiento e historial',
      balance: 'Saldo',
    ...
    absences: {
      ...
      patternDesc: 'Configura tus días habituales de teletrabajo',
      patternUpdated: 'Patrón guardado',
      importIcal: 'Importar calendario',
      importDesc: 'Importa ausencias desde archivos de calendario .ics',
      importDropzone: 'Arrastra un archivo .ics aquí o haz clic para buscar',
      ...
      todayBannerDesc: 'Hoy estás marcado como ausente',
      'todayBanner.homeoffice': 'Teletrabajo',
    ...
    admin: {
      ...
      refillAll: 'Recargar todos los usuarios',
      amount: 'Cantidad',
      grant: 'Conceder',
    },
    common: {
