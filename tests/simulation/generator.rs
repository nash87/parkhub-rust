...
const FIRST_NAMES: &[&str] = &[
    ...
    "Ines", "Jan", "Katharina", "Lukas", "Marie", "Niklas", "Olivia",
    "Paul", "Quirin", "Rosa", "Stefan", "Tanja", "Uwe", "Vera", "Wolfgang",
    "Xenia", "Yannick", "Zoe", "Alexander", "Bianca", "Christian", "Diana",
    "Erik", "Franziska", "Georg", "Helena", "Igor", "Julia", "Klaus",
    "Laura", "Markus", "Nina", "Otto", "Petra", "Robert", "Sabine",
    "Thomas", "Ursula", "Viktor", "Waltraud", "Maximilian", "Sophie",
];
...
const LAST_NAMES: &[&str] = &[
    ...
    "Peters", "Lang", "Scholz", "Moeller", "Weiland", "Jung",
    "Gross", "Friedrich",
];

/// German city codes for license plates.
const CITY_CODES: &[&str] = &[
    "M", "B", "HH", "K", "F", "S", "D", "HB", "H", "N",
    "DO", "E", "DD", "L", "KA", "WI", "MA", "A", "KI", "LU",
    "FR", "MS", "OL", "DA", "GI", "MR", "OF", "AC", "BN", "SB",
];
